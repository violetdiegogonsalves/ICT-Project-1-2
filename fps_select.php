<?php
	...
	if ($assets_id) {
		$output = '';
		$query = "SELECT * FROM fps_assets WHERE id = '".$_POST["assets_id"]."'";
		$connect = db_connect();
                    ...
                    <td>
						<script type="text/javascript">
							function saveLink(){
								...
								$.ajax({
									url:"include/fps_saveLink.php",
									method:'post',
									data:{fps_link:$('#link').val(),assets_id:$('#assetId').val()},
								}).done(function(data){
...
ROW;
		...
		$querySub = "SELECT * FROM fps_assets_sub WHERE FK_ASSET = '".$_POST["assets_id"]."'";
